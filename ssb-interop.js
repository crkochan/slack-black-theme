    ...
    ipcRenderer
        .on('SLACK_NOTIFY_CHILD_WINDOW_EVENT', (event, method, ...args) => {
            try {
                ...
                console.error(`Cannot execute method`, { error, method });
//tslint:disable-line:no-console
    ...
    ipcRenderer.send('SLACK_PRQ_TEAM_BOOTED');
// Main process will respond SLACK_PRQ_TEAM_BOOT_ORDER
...
body {
    ...
    src: url('https://fonts.googleapis.com/css?family=Lato:300,400,700,900');
...
span.c-message__body, span.c-message_attachment__media_trigger.c-message_attachment__media_trigger--caption, div.p-message_pane__foreword__description span {
    // color: white;
    font-size: 15px;
